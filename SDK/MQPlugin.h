...
public:
	...
	MQPoint(float nx, float ny, float nz)
	{
		x = nx;
		y = ny;
		z = nz;
...
public:
	...
	MQColor(float nr, float ng, float nb)
	{
		r = nr;
		g = ng;
		b = nb;
...
public:
	...
	MQColorRGBA(float nr, float ng, float nb, float na)
	{
		r = nr;
		g = ng;
		b = nb;
...
public:
	...
	MQCoordinate(float nu, float nv)
	{
		u = nu;
		v = nv;
	}
...
struct MQAngle
{
	...
	MQAngle(float h, float p, float b)
	{
		head = h;
		pich = p;
		bank = b;
...
public:
	...
	MQMatrix& operator *=(const MQMatrix mat)
	{
		*this = (*this * mat);
		return *this;
	}
...
struct MQSelectLine
{
	...
	MQSelectLine(int i, int j, int k)
	{
		object = i;
		face = j;
		line = k;
...
public:
	...
	MQPoint Convert3DToScreen(const MQPoint& p, float* out_w = nullptr);
...
inline void MQCDocument::GetUnusedObjectName(char* buffer, int buffer_size) { return MQDoc_GetUnusedObjectName(this, buffer, buffer_size, nullptr); }
...
inline void MQCDocument::GetUnusedMaterialName(char* buffer, int buffer_size) { return MQDoc_GetUnusedMaterialName(this, buffer, buffer_size, nullptr); }
...
inline MQPoint MQCScene::GetCameraPosition()
{
	float val[3];
	MQScene_FloatValue(this, MQSCENE_GET_CAMERA_POS, val);
	return MQPoint(val[0], val[1], val[2]);
}

inline MQAngle MQCScene::GetCameraAngle()
{
	float val[3];
	MQScene_FloatValue(this, MQSCENE_GET_CAMERA_ANGLE, val);
	return MQAngle(val[0], val[1], val[2]);
}

inline MQPoint MQCScene::GetLookAtPosition()
{
	float val[3];
	MQScene_FloatValue(this, MQSCENE_GET_LOOK_AT_POS, val);
	return MQPoint(val[0], val[1], val[2]);
}

inline MQPoint MQCScene::GetRotationCenter()
{
	float val[3];
	MQScene_FloatValue(this, MQSCENE_GET_ROTATION_CENTER, val);
	return MQPoint(val[0], val[1], val[2]);
}

inline float MQCScene::GetFOV()
{
	float val;
	MQScene_FloatValue(this, MQSCENE_GET_FOV, &val);
	return val;
}
...
inline MQColor MQCScene::GetGlobalAmbientColor()
{
	float val[3];
	MQScene_FloatValue(this, MQSCENE_GET_AMBIENT_COLOR, val);
	return MQColor(val[0], val[1], val[2]);
}

inline void MQCScene::SetCameraPosition(const MQPoint& p)
{
	float val[3];
	val[0] = p.x;
	val[1] = p.y;
	val[2] = p.z;
	MQScene_FloatValue(this, MQSCENE_SET_CAMERA_POS, val);
}

inline void MQCScene::SetCameraAngle(const MQAngle& angle)
{
	float val[3];
	val[0] = angle.head;
	val[1] = angle.pich;
	val[2] = angle.bank;
	MQScene_FloatValue(this, MQSCENE_SET_CAMERA_ANGLE, val);
}

inline void MQCScene::SetLookAtPosition(const MQPoint& p)
{
	float val[6];
	val[0] = p.x;
	val[1] = p.y;
	...
	val[4] = 1;
	val[5] = 0;
	MQScene_FloatValue(this, MQSCENE_SET_LOOK_AT_POS, val);
}

inline void MQCScene::SetRotationCenter(const MQPoint& p)
{
	float val[3];
	val[0] = p.x;
	val[1] = p.y;
	val[2] = p.z;
	MQScene_FloatValue(this, MQSCENE_SET_ROTATION_CENTER, val);
}
...
inline void MQCScene::SetGlobalAmbientColor(const MQColor& amb)
{
	float val[3];
	val[0] = amb.r;
	val[1] = amb.g;
	val[2] = amb.b;
	MQScene_FloatValue(this, MQSCENE_SET_AMBIENT_COLOR, val);
}
...
inline int MQCScene::AddGlobalDirectionalLight()
{
	int val[1];
	MQScene_IntValue(this, MQSCENE_ADD_MULTILIGHT, val);
	return val[0];
}

inline BOOL MQCScene::DeleteGlobalDirectionalLight(int index)
{
	int val[2];
	val[0] = index;
	MQScene_IntValue(this, MQSCENE_DELETE_MULTILIGHT, val);
	return val[1] ? TRUE : FALSE;
}

inline int MQCScene::GetGlobalDirectionalLightNum()
{
	int val[1];
	MQScene_IntValue(this, MQSCENE_GET_MULTILIGHT_NUMBER, val);
	return val[0];
}

inline MQPoint MQCScene::GetGlobalDirectionalLightDirection(int index)
{
	float val[3];
	MQScene_IntValue(this, MQSCENE_SET_MULTILIGHT_INDEX, &index);
	MQScene_FloatValue(this, MQSCENE_GET_MULTILIGHT_DIR, val);
	return MQPoint(val[0], val[1], val[2]);
}

inline MQColor MQCScene::GetGlobalDirectionalLightColor(int index)
{
	float val[3];
	MQScene_IntValue(this, MQSCENE_SET_MULTILIGHT_INDEX, &index);
	MQScene_FloatValue(this, MQSCENE_GET_MULTILIGHT_COLOR, val);
	return MQColor(val[0], val[1], val[2]);
}

inline void MQCScene::SetGlobalDirectionalLightDirection(int index, const MQPoint& dir)
{
	float val[3];
	MQScene_IntValue(this, MQSCENE_SET_MULTILIGHT_INDEX, &index);
	val[0] = dir.x;
	val[1] = dir.y;
	val[2] = dir.z;
	MQScene_FloatValue(this, MQSCENE_SET_MULTILIGHT_DIR, val);
}

inline void MQCScene::SetGlobalDirectionalLightColor(int index, const MQColor& col)
{
	float val[3];
	MQScene_IntValue(this, MQSCENE_SET_MULTILIGHT_INDEX, &index);
	val[0] = col.r;
	val[1] = col.g;
	val[2] = col.b;
	MQScene_FloatValue(this, MQSCENE_SET_MULTILIGHT_COLOR, val);
}

inline float MQCScene::GetFrontZ()
{
	float val;
	MQScene_FloatValue(this, MQSCENE_GET_FRONT_Z, &val);
	return val;
}

inline bool MQCScene::GetOrtho()
{
	int val = 0;
	MQScene_IntValue(this, MQSCENE_GET_ORTHO, &val);
	return val != 0;
}

inline void MQCScene::SetOrtho(bool ortho)
{
	int val = ortho ? 1 : 0;
	MQScene_IntValue(this, MQSCENE_SET_ORTHO, &val);
}

inline float MQCScene::GetZoom()
{
	float val = 1.0f;
	MQScene_FloatValue(this, MQSCENE_GET_ZOOM, &val);
	return val;
}

inline void MQCScene::SetZoom(float fov) { MQScene_FloatValue(this, MQSCENE_SET_ZOOM, &fov); }

inline float MQCScene::GetFrontClip()
{
	float val = 1.0f;
	MQScene_FloatValue(this, MQSCENE_GET_FRONT_CLIP, &val);
	return val;
}

inline float MQCScene::GetBackClip()
{
	float val = 1.0f;
	MQScene_FloatValue(this, MQSCENE_GET_BACK_CLIP, &val);
	return val;
}
...
inline std::string MQCObject::GetName()
{
	char buffer[64];
	MQObj_GetName(this, buffer, sizeof(buffer));
	return std::string(buffer);
}

inline int MQCObject::GetVertexCount(void) { return MQObj_GetVertexCount(this); }

inline MQPoint MQCObject::GetVertex(int index)
{
	MQPoint pts;
	MQObj_GetVertex(this, index, &pts);
	return pts;
}
...
inline MQColor MQCObject::GetColor(void)
{
	float val[3];
	MQObj_GetFloatArray(this, MQOBJ_ID_COLOR, val);
	return MQColor(val[0], val[1], val[2]);
}

inline void MQCObject::SetColor(MQColor color)
{
	float val[3];
	val[0] = color.r;
	val[1] = color.g;
	val[2] = color.b;
	MQObj_SetFloatArray(this, MQOBJ_ID_COLOR, val);
}
...
inline MQPoint MQCObject::GetScaling(void)
{
	float val[3];
	MQObj_GetFloatArray(this, MQOBJ_ID_SCALING, val);
	return MQPoint(val[0], val[1], val[2]);
}

inline void MQCObject::SetScaling(MQPoint scale)
{
	float val[3];
	val[0] = scale.x;
	val[1] = scale.y;
	val[2] = scale.z;
	MQObj_SetFloatArray(this, MQOBJ_ID_SCALING, val);
}

inline MQAngle MQCObject::GetRotation(void)
{
	float val[3];
	MQObj_GetFloatArray(this, MQOBJ_ID_ROTATION, val);
	return MQAngle(val[0], val[1], val[2]);
}

inline void MQCObject::SetRotation(MQAngle angle)
{
	float val[3];
	val[0] = angle.head;
	val[1] = angle.pich;
	val[2] = angle.bank;
	MQObj_SetFloatArray(this, MQOBJ_ID_ROTATION, val);
}

inline MQPoint MQCObject::GetTranslation(void)
{
	float val[3];
	MQObj_GetFloatArray(this, MQOBJ_ID_TRANSLATION, val);
	return MQPoint(val[0], val[1], val[2]);
}

inline void MQCObject::SetTranslation(MQPoint trans)
{
	float val[3];
	val[0] = trans.x;
	val[1] = trans.y;
	val[2] = trans.z;
	MQObj_SetFloatArray(this, MQOBJ_ID_TRANSLATION, val);
}

inline MQMatrix MQCObject::GetLocalMatrix(void)
{
	MQMatrix mtx;
	MQObj_GetFloatArray(this, MQOBJ_ID_LOCAL_MATRIX, mtx.t);
	return mtx;
}

inline void MQCObject::SetLocalMatrix(const MQMatrix& mtx) { MQObj_SetFloatArray(this, MQOBJ_ID_LOCAL_MATRIX, mtx.t); }

inline MQMatrix MQCObject::GetLocalInverseMatrix(void)
{
	MQMatrix mtx;
	MQObj_GetFloatArray(this, MQOBJ_ID_LOCAL_INVERSE_MATRIX, mtx.t);
	return mtx;
}
...
inline float MQCObject::GetLightValue(void)
{
	float val[1];
	MQObj_GetFloatArray(this, MQOBJ_ID_LIGHT_VALUE, val);
	return val[0];
}

inline void MQCObject::SetLightValue(float value)
{
	float val[1];
	val[0] = value;
	MQObj_SetFloatArray(this, MQOBJ_ID_LIGHT_VALUE, val);
}
...
inline float MQCObject::GetLightFallOffEnd(void)
{
	float val[1];
	MQObj_GetFloatArray(this, MQOBJ_ID_LIGHT_FALLOFF_END, val);
	return val[0];
}

inline void MQCObject::SetLightFallOffEnd(float distance)
{
	float val[1];
	val[0] = distance;
	MQObj_SetFloatArray(this, MQOBJ_ID_LIGHT_FALLOFF_END, val);
}

inline float MQCObject::GetLightFallOffHalf(void)
{
	float val[1];
	MQObj_GetFloatArray(this, MQOBJ_ID_LIGHT_FALLOFF_HALF, val);
	return val[0];
}

inline void MQCObject::SetLightFallOffHalf(float distance)
{
	float val[1];
	val[0] = distance;
	MQObj_SetFloatArray(this, MQOBJ_ID_LIGHT_FALLOFF_HALF, val);
}
...
inline void MQCObject::AddRenderFlag(MQOBJECT_RENDER_FLAG flag)
{
	...
	switch (flag)
	{
	case MQOBJECT_RENDER_POINT: ptr[0] = "point";
		break;
	case MQOBJECT_RENDER_LINE: ptr[0] = "line";
		break;
	case MQOBJECT_RENDER_FACE: ptr[0] = "face";
		break;
	case MQOBJECT_RENDER_OVERWRITELINE: ptr[0] = "overwriteline";
		break;
	case MQOBJECT_RENDER_OVERWRITEFACE: ptr[0] = "overwriteface";
		break;
	case MQOBJECT_RENDER_ALPHABLEND: ptr[0] = "alphablend";
		break;
	case MQOBJECT_RENDER_MULTILIGHT: ptr[0] = "multilight";
		break;
	case MQOBJECT_RENDER_SHADOW: ptr[0] = "shadow";
		break;
	case MQOBJECT_RENDER_VERTEXCOLORPOINT: ptr[0] = "vcolpoint";
		break;
	case MQOBJECT_RENDER_SCREEN: ptr[0] = "screen";
		break;
	}
	ptr[1] = nullptr;
...
inline std::string MQCMaterial::GetName()
{
	char buffer[64];
	MQMat_GetName(this, buffer, sizeof(buffer));
	return std::string(buffer);
}
...
inline MQColor MQCMaterial::GetColor(void)
{
	MQColor color;
	MQMat_GetColor(this, &color);
	return color;
}
...
inline MQColor MQCMaterial::GetAmbientColor(void)
{
	float val[3];
	MQMat_GetFloatArray(this, MQMAT_ID_AMBIENT_COLOR, val);
	return MQColor(val[0], val[1], val[2]);
}

inline MQColor MQCMaterial::GetEmissionColor(void)
{
	float val[3];
	MQMat_GetFloatArray(this, MQMAT_ID_EMISSION_COLOR, val);
	return MQColor(val[0], val[1], val[2]);
}

inline MQColor MQCMaterial::GetSpecularColor(void)
{
	float val[3];
	MQMat_GetFloatArray(this, MQMAT_ID_SPECULAR_COLOR, val);
	return MQColor(val[0], val[1], val[2]);
}
...
inline float MQCMaterial::GetReflection(void)
{
	float val[1];
	MQMat_GetFloatArray(this, MQMAT_ID_REFLECTION, val);
	return val[0];
}

inline float MQCMaterial::GetRefraction(void)
{
	float val[1];
	MQMat_GetFloatArray(this, MQMAT_ID_REFRACTION, val);
	return val[0];
}

inline int MQCMaterial::GetMappingType(void) { return MQMat_GetIntValue(this, MQMAT_ID_MAPPROJ); }

inline MQPoint MQCMaterial::GetMappingPosition(void)
{
	float val[3];
	MQMat_GetFloatArray(this, MQMAT_ID_MAPPROJ_POSITION, val);
	return MQPoint(val[0], val[1], val[2]);
}

inline MQPoint MQCMaterial::GetMappingScaling(void)
{
	float val[3];
	MQMat_GetFloatArray(this, MQMAT_ID_MAPPROJ_SCALING, val);
	return MQPoint(val[0], val[1], val[2]);
}

inline MQAngle MQCMaterial::GetMappingAngle(void)
{
	float val[3];
	MQMat_GetFloatArray(this, MQMAT_ID_MAPPROJ_ANGLE, val);
	return MQAngle(val[0], val[1], val[2]);
}
...
inline void MQCMaterial::SetAmbientColor(MQColor color)
{
	float val[3] = {color.r, color.g, color.b};
	MQMat_SetFloatArray(this, MQMAT_ID_AMBIENT_COLOR, val);
}

inline void MQCMaterial::SetEmissionColor(MQColor color)
{
	float val[3] = {color.r, color.g, color.b};
	MQMat_SetFloatArray(this, MQMAT_ID_EMISSION_COLOR, val);
}

inline void MQCMaterial::SetSpecularColor(MQColor color)
{
	float val[3] = {color.r, color.g, color.b};
	MQMat_SetFloatArray(this, MQMAT_ID_SPECULAR_COLOR, val);
}

inline void MQCMaterial::SetReflection(float value)
{
	float val[1];
	val[0] = value;
	MQMat_SetFloatArray(this, MQMAT_ID_REFLECTION, val);
}

inline void MQCMaterial::SetRefraction(float value)
{
	float val[1];
	val[0] = value;
	MQMat_SetFloatArray(this, MQMAT_ID_REFRACTION, val);
}

inline void MQCMaterial::SetMappingType(int type) { MQMat_SetIntValue(this, MQMAT_ID_MAPPROJ, type); }

inline void MQCMaterial::SetMappingPosition(MQPoint pos)
{
	float val[3];
	val[0] = pos.x;
	val[1] = pos.y;
	val[2] = pos.z;
	MQMat_SetFloatArray(this, MQMAT_ID_MAPPROJ_POSITION, val);
}

inline void MQCMaterial::SetMappingScaling(MQPoint scale)
{
	float val[3];
	val[0] = scale.x;
	val[1] = scale.y;
	val[2] = scale.z;
	MQMat_SetFloatArray(this, MQMAT_ID_MAPPROJ_SCALING, val);
}

inline void MQCMaterial::SetMappingAngle(MQAngle angle)
{
	float val[3];
	val[0] = angle.head;
	val[1] = angle.pich;
	val[2] = angle.bank;
	MQMat_SetFloatArray(this, MQMAT_ID_MAPPROJ_ANGLE, val);
}
...
inline int MQCMaterial::GetShaderName(char* buffer, int buffer_size)
{
	int length = 0;
	void* array[3];
	array[0] = buffer;
	array[1] = &buffer_size;
	array[2] = &length;
	MQMat_GetValueArray(this, MQMAT_ID_SHADER_NAME, array);
	return length;
}

inline std::string MQCMaterial::GetShaderName(void)
{
	char buffer[64];
	GetShaderName(buffer, sizeof(buffer));
	return std::string(buffer);
}

inline int MQCMaterial::GetShaderParameterNum(void)
{
	int num = 0;
	void* array[1];
	array[0] = &num;
	MQMat_GetValueArray(this, MQMAT_ID_SHADER_PARAM_NUM, array);
	return num;
}

inline int MQCMaterial::GetShaderParameterName(int index, char* buffer, int buffer_size)
{
	int length = 0;
	void* array[4];
	array[0] = &index;
	...
	array[2] = &buffer_size;
	array[3] = &length;
	MQMat_GetValueArray(this, MQMAT_ID_SHADER_PARAM_NAME, array);
	return length;
}

inline std::string MQCMaterial::GetShaderParameterName(int index)
{
	char buffer[64];
	GetShaderParameterName(index, buffer, sizeof(buffer));
	return std::string(buffer);
}

inline int MQCMaterial::GetShaderParameterValueType(int index)
{
	int type = 0;
	void* array[3];
	array[0] = &index;
	array[1] = nullptr;
	array[2] = &type;
	MQMat_GetValueArray(this, MQMAT_ID_SHADER_PARAM_VALUE_TYPE, array);
	return type;
}

inline int MQCMaterial::GetShaderParameterValueType(const char* name)
{
	int type = 0;
	void* array[3];
	array[0] = nullptr;
...
inline int MQCMaterial::GetShaderParameterArraySize(int index)
{
	int num = 0;
	void* array[3];
	array[0] = &index;
	array[1] = nullptr;
	array[2] = &num;
	MQMat_GetValueArray(this, MQMAT_ID_SHADER_PARAM_ARRAY_SIZE, array);
	return num;
}

inline int MQCMaterial::GetShaderParameterArraySize(const char* name)
{
	int num = 0;
	void* array[3];
	array[0] = nullptr;
...
inline bool MQCMaterial::GetShaderParameterBoolValue(int index, int array_index)
{
	int value = 0;
	void* array[4];
	array[0] = &index;
	...
	array[2] = &array_index;
	array[3] = &value;
	MQMat_GetValueArray(this, MQMAT_ID_SHADER_PARAM_INT_VALUE, array);
	return value != 0;
}

inline bool MQCMaterial::GetShaderParameterBoolValue(const char* name, int array_index)
{
	int value = 0;
	void* array[4];
	array[0] = nullptr;
...
inline int MQCMaterial::GetShaderParameterIntValue(int index, int array_index)
{
	int value = 0;
	void* array[4];
	array[0] = &index;
...
inline int MQCMaterial::GetShaderParameterIntValue(const char* name, int array_index)
{
	int value = 0;
	void* array[4];
	array[0] = nullptr;
...
inline float MQCMaterial::GetShaderParameterFloatValue(int index, int array_index)
{
	float value = 0;
	void* array[4];
	array[0] = &index;
	...
	array[2] = &array_index;
	array[3] = &value;
	MQMat_GetValueArray(this, MQMAT_ID_SHADER_PARAM_FLOAT_VALUE, array);
	return value;
}

inline float MQCMaterial::GetShaderParameterFloatValue(const char* name, int array_index)
{
	float value = 0;
	void* array[4];
	array[0] = nullptr;
...
inline MQColorRGBA MQCMaterial::GetShaderParameterColorValue(int index, int array_index)
{
	MQColorRGBA value(0, 0, 0, 0);
	void* array[4];
	array[0] = &index;
	array[1] = nullptr;
	array[2] = &array_index;
	array[3] = &value;
	MQMat_GetValueArray(this, MQMAT_ID_SHADER_PARAM_COLOR_VALUE, array);
	return value;
}

inline MQColorRGBA MQCMaterial::GetShaderParameterColorValue(const char* name, int array_index)
{
	MQColorRGBA value(0, 0, 0, 0);
	void* array[4];
	array[0] = nullptr;
...
inline int MQCMaterial::GetShaderMappingNum(void)
{
	int num = 0;
	void* array[1];
	array[0] = &num;
	MQMat_GetValueArray(this, MQMAT_ID_SHADER_MAP_NUM, array);
	return num;
}

inline int MQCMaterial::GetShaderMappingName(int index, char* buffer, int buffer_size)
{
	int length = 0;
	void* array[4];
	array[0] = &index;
	...
	array[2] = &buffer_size;
	array[3] = &length;
	MQMat_GetValueArray(this, MQMAT_ID_SHADER_MAP_NAME, array);
	return length;
}

inline std::string MQCMaterial::GetShaderMappingName(int index)
{
	char buffer[64];
	GetShaderMappingName(index, buffer, sizeof(buffer));
	return std::string(buffer);
}

inline int MQCMaterial::GetShaderMappingFilename(int index, char* buffer, int buffer_size)
{
	int length = 0;
	void* array[5];
	array[0] = &index;
	...
	array[3] = &buffer_size;
	array[4] = &length;
	MQMat_GetValueArray(this, MQMAT_ID_SHADER_MAP_FILENAME, array);
	return length;
}

inline int MQCMaterial::GetShaderMappingFilename(const char* name, char* buffer, int buffer_size)
{
	int length = 0;
	void* array[5];
	array[0] = nullptr;
...
inline int MQCMaterial::GetShaderMappingFilename(int index, wchar_t* buffer, int buffer_size)
{
	int length = 0;
	void* array[5];
	array[0] = &index;
	...
	array[3] = &buffer_size;
	array[4] = &length;
	MQMat_GetValueArray(this, MQMAT_ID_SHADER_MAP_FILENAME_W, array);
	return length;
}

inline int MQCMaterial::GetShaderMappingFilename(const char* name, wchar_t* buffer, int buffer_size)
{
	int length = 0;
	void* array[5];
	array[0] = nullptr;
...
inline std::string MQCMaterial::GetShaderMappingFilenameA(int index)
{
	int len = GetShaderMappingFilename(index, (char*)nullptr, 0);
	if (len == 0) return std::string();
	char* buffer = new char[len + 1];
	GetShaderMappingFilename(index, buffer, len + 1);
	std::string str(buffer);
	delete[] buffer;
	return str;
}

inline std::string MQCMaterial::GetShaderMappingFilenameA(const char* name)
{
	int len = GetShaderMappingFilename(name, (wchar_t*)nullptr, 0);
	if (len == 0) return std::string();
	char* buffer = new char[len + 1];
	GetShaderMappingFilename(name, buffer, len + 1);
	std::string str(buffer);
	delete[] buffer;
	return str;
}

inline std::wstring MQCMaterial::GetShaderMappingFilenameW(int index)
{
	int len = GetShaderMappingFilename(index, (wchar_t*)nullptr, 0);
...
inline std::wstring MQCMaterial::GetShaderMappingFilenameW(const char* name)
{
	int len = GetShaderMappingFilename(name, (wchar_t*)nullptr, 0);
	if (len == 0) return std::wstring();
	wchar_t* buffer = new wchar_t[len + 1];
...
inline void MQCMaterial::SetShaderParameterBoolValue(int index, int array_index, bool value)
{
	void* array[4];
	array[0] = &index;
	array[1] = nullptr;
	array[2] = &array_index;
	array[3] = &value;
	MQMat_SetValueArray(this, MQMAT_ID_SHADER_PARAM_INT_VALUE, array);
}

inline void MQCMaterial::SetShaderParameterBoolValue(const char* name, int array_index, bool value)
{
	void* array[4];
	array[0] = nullptr;
	array[1] = (void*)name;
...
inline void MQCMaterial::SetShaderParameterIntValue(int index, int array_index, int value)
{
	void* array[4];
	array[0] = &index;
	array[1] = nullptr;
...
inline void MQCMaterial::SetShaderParameterIntValue(const char* name, int array_index, int value)
{
	void* array[4];
	array[0] = nullptr;
	array[1] = (void*)name;
...
inline void MQCMaterial::SetShaderParameterFloatValue(int index, int array_index, float value)
{
	void* array[4];
	array[0] = &index;
	array[1] = nullptr;
	array[2] = &array_index;
	array[3] = &value;
	MQMat_SetValueArray(this, MQMAT_ID_SHADER_PARAM_FLOAT_VALUE, array);
}

inline void MQCMaterial::SetShaderParameterFloatValue(const char* name, int array_index, float value)
{
	void* array[4];
	array[0] = nullptr;
	array[1] = (void*)name;
...
inline void MQCMaterial::SetShaderParameterColorValue(int index, int array_index, MQColorRGBA color)
{
	void* array[4];
	array[0] = &index;
	array[1] = nullptr;
	array[2] = &array_index;
	array[3] = &color;
	MQMat_SetValueArray(this, MQMAT_ID_SHADER_PARAM_COLOR_VALUE, array);
}

inline void MQCMaterial::SetShaderParameterColorValue(const char* name, int array_index, MQColorRGBA color)
{
	void* array[4];
	array[0] = nullptr;
	array[1] = (void*)name;
...
inline void MQCMaterial::SetShaderMappingFilename(int index, const char* buffer)
{
	void* array[3];
	array[0] = &index;
	array[1] = nullptr;
	array[2] = (void*)buffer;
	MQMat_SetValueArray(this, MQMAT_ID_SHADER_MAP_FILENAME, array);
}

inline void MQCMaterial::SetShaderMappingFilename(const char* name, const char* buffer)
{
	void* array[3];
	array[0] = nullptr;
	array[1] = (void*)name;
...
inline void MQCMaterial::SetShaderMappingFilename(int index, const wchar_t* buffer)
{
	void* array[3];
	array[0] = &index;
	array[1] = nullptr;
	array[2] = (void*)buffer;
	MQMat_SetValueArray(this, MQMAT_ID_SHADER_MAP_FILENAME_W, array);
}

inline void MQCMaterial::SetShaderMappingFilename(const char* name, const wchar_t* buffer)
{
	void* array[3];
	array[0] = nullptr;
	array[1] = (void*)name;
...
inline bool MQCMaterial::SetShaderName(const char* name)
{
	bool result = false;
	void* array[2];
	array[0] = (void*)name;
	array[1] = &result;
	MQMat_SetValueArray(this, MQMAT_ID_SHADER_NAME, array);
	return result;
}
...
inline int MQCMaterial::GetSubShaderNodeNum()
{
	int num = 0;
	void* array[1];
	array[0] = &num;
	MQMat_GetValueArray(this, MQMAT_ID_SUBSHADER_NUM, array);
	return num;
}

inline std::string MQCMaterial::GetSubShaderNodeID(int index)
{
	const char* result = nullptr;
	void* array[2];
	array[0] = &index;
	array[1] = &result;
	MQMat_GetValueArray(this, MQMAT_ID_SUBSHADER_ID, array);
	if (result == nullptr) return std::string();
	return std::string(result);
}

inline MQShaderNode MQCMaterial::GetSubShaderNode(int index)
{
	MQShaderNode shader = nullptr;
	void* array[3];
	array[0] = &index;
	array[1] = nullptr;
	array[2] = &shader;
	MQMat_GetValueArray(this, MQMAT_ID_SUBSHADER, array);
	return shader;
}

inline MQShaderNode MQCMaterial::GetSubShaderNode(const char* id)
{
	MQShaderNode shader = nullptr;
	void* array[3];
	array[0] = nullptr;
...
// class MQShaderNode
inline int MQCShaderNode::GetShaderName(char* buffer, int buffer_size)
{
	int length = 0;
	void* array[3];
	array[0] = buffer;
	array[1] = &buffer_size;
	array[2] = &length;
	MQShaderNode_GetValueArray(this, MQMAT_ID_SHADER_NAME, array);
	return length;
}

inline std::string MQCShaderNode::GetShaderName(void)
{
	char buffer[64];
	GetShaderName(buffer, sizeof(buffer));
	return std::string(buffer);
...
{
	int length = GetOptionValue(option_name, nullptr, 0);
...
inline int MQCShaderNode::GetParameterNum(void)
{
	int num = 0;
	void* array[1];
	array[0] = &num;
	MQShaderNode_GetValueArray(this, MQMAT_ID_SHADER_PARAM_NUM, array);
	return num;
}

inline int MQCShaderNode::GetParameterName(int index, char* buffer, int buffer_size)
{
	int length = 0;
	void* array[4];
	array[0] = &index;
	...
	array[2] = &buffer_size;
	array[3] = &length;
	MQShaderNode_GetValueArray(this, MQMAT_ID_SHADER_PARAM_NAME, array);
	return length;
}

inline std::string MQCShaderNode::GetParameterName(int index)
{
	char buffer[64];
	GetParameterName(index, buffer, sizeof(buffer));
	return std::string(buffer);
}
...
{
	int length = GetParameterOptionValue(index, option_name, nullptr, 0);
	if (length == 0) return std::string();
	char* buffer = (char*)malloc(length + 1);
...
{
	int length = GetParameterOptionValue(name, option_name, nullptr, 0);
	if (length == 0) return std::string();
	char* buffer = (char*)malloc(length + 1);
...
inline int MQCShaderNode::GetParameterValueType(int index)
{
	int type = 0;
	void* array[3];
	array[0] = &index;
	array[1] = nullptr;
	array[2] = &type;
	MQShaderNode_GetValueArray(this, MQMAT_ID_SHADER_PARAM_VALUE_TYPE, array);
	return type;
}

inline int MQCShaderNode::GetParameterValueType(const char* name)
{
	int type = 0;
	void* array[3];
	array[0] = nullptr;
...
inline int MQCShaderNode::GetParameterArraySize(int index)
{
	int num = 0;
	void* array[3];
	array[0] = &index;
	array[1] = nullptr;
	array[2] = &num;
	MQShaderNode_GetValueArray(this, MQMAT_ID_SHADER_PARAM_ARRAY_SIZE, array);
	return num;
}

inline int MQCShaderNode::GetParameterArraySize(const char* name)
{
	int num = 0;
	void* array[3];
	array[0] = nullptr;
...
inline bool MQCShaderNode::GetParameterBoolValue(int index, int array_index)
{
	int value = 0;
	void* array[4];
	array[0] = &index;
	...
	array[2] = &array_index;
	array[3] = &value;
	MQShaderNode_GetValueArray(this, MQMAT_ID_SHADER_PARAM_INT_VALUE, array);
	return value != 0;
}

inline bool MQCShaderNode::GetParameterBoolValue(const char* name, int array_index)
{
	int value = 0;
	void* array[4];
	array[0] = nullptr;
...
inline int MQCShaderNode::GetParameterIntValue(int index, int array_index)
{
	int value = 0;
	void* array[4];
	array[0] = &index;
...
inline int MQCShaderNode::GetParameterIntValue(const char* name, int array_index)
{
	int value = 0;
	void* array[4];
	array[0] = nullptr;
...
inline float MQCShaderNode::GetParameterFloatValue(int index, int array_index)
{
	float value = 0;
	void* array[4];
	array[0] = &index;
	...
	array[2] = &array_index;
	array[3] = &value;
	MQShaderNode_GetValueArray(this, MQMAT_ID_SHADER_PARAM_FLOAT_VALUE, array);
	return value;
}

inline float MQCShaderNode::GetParameterFloatValue(const char* name, int array_index)
{
	float value = 0;
	void* array[4];
	array[0] = nullptr;
...
inline MQColorRGBA MQCShaderNode::GetParameterColorValue(int index, int array_index)
{
	MQColorRGBA value(0, 0, 0, 0);
	void* array[4];
	array[0] = &index;
	...
	array[2] = &array_index;
	array[3] = &value;
	MQShaderNode_GetValueArray(this, MQMAT_ID_SHADER_PARAM_COLOR_VALUE, array);
	return value;
}

inline MQColorRGBA MQCShaderNode::GetParameterColorValue(const char* name, int array_index)
{
	MQColorRGBA value(0, 0, 0, 0);
	void* array[4];
	array[0] = nullptr;
...
inline std::string MQCShaderNode::GetParameterStringValue(int index, int array_index)
{
	...
	array[2] = &array_index;
	array[3] = &value;
	MQShaderNode_GetValueArray(this, MQMAT_ID_SHADER_PARAM_STRING_VALUE, array);
	if (value == nullptr) return std::string();
	return std::string(value);
}

inline std::string MQCShaderNode::GetParameterStringValue(const char* name, int array_index)
{
	const char* value = nullptr;
	void* array[4];
	array[0] = nullptr;
...
inline void MQCShaderNode::SetParameterBoolValue(int index, int array_index, bool value)
{
	void* array[4];
	array[0] = &index;
	array[1] = nullptr;
	array[2] = &array_index;
	array[3] = &value;
	MQShaderNode_SetValueArray(this, MQMAT_ID_SHADER_PARAM_INT_VALUE, array);
}

inline void MQCShaderNode::SetParameterBoolValue(const char* name, int array_index, bool value)
{
	void* array[4];
	array[0] = nullptr;
	array[1] = (void*)name;
...
inline void MQCShaderNode::SetParameterIntValue(int index, int array_index, int value)
{
	void* array[4];
	array[0] = &index;
	array[1] = nullptr;
...
inline void MQCShaderNode::SetParameterIntValue(const char* name, int array_index, int value)
{
	void* array[4];
	array[0] = nullptr;
	array[1] = (void*)name;
...
inline void MQCShaderNode::SetParameterFloatValue(int index, int array_index, float value)
{
	void* array[4];
	array[0] = &index;
	array[1] = nullptr;
	array[2] = &array_index;
	array[3] = &value;
	MQShaderNode_SetValueArray(this, MQMAT_ID_SHADER_PARAM_FLOAT_VALUE, array);
}

inline void MQCShaderNode::SetParameterFloatValue(const char* name, int array_index, float value)
{
	void* array[4];
	array[0] = nullptr;
	array[1] = (void*)name;
...
inline void MQCShaderNode::SetParameterColorValue(int index, int array_index, MQColorRGBA color)
{
	void* array[4];
	array[0] = &index;
	array[1] = nullptr;
	array[2] = &array_index;
	array[3] = &color;
	MQShaderNode_SetValueArray(this, MQMAT_ID_SHADER_PARAM_COLOR_VALUE, array);
}

inline void MQCShaderNode::SetParameterColorValue(const char* name, int array_index, MQColorRGBA color)
{
	void* array[4];
	array[0] = nullptr;
	array[1] = (void*)name;
...
inline void MQCShaderNode::SetParameterStringValue(int index, int array_index, const char* str)
{
	void* array[4];
	array[0] = &index;
	array[1] = nullptr;
	array[2] = &array_index;
	array[3] = (void*)str;
	MQShaderNode_SetValueArray(this, MQMAT_ID_SHADER_PARAM_STRING_VALUE, array);
}

inline void MQCShaderNode::SetParameterStringValue(const char* name, int array_index, const char* str)
{
	void* array[4];
	array[0] = nullptr;
	array[1] = (void*)name;
...
inline int MQCShaderNode::GetMappingNum(void)
{
	int num = 0;
	void* array[1];
	array[0] = &num;
	MQShaderNode_GetValueArray(this, MQMAT_ID_SHADER_MAP_NUM, array);
	return num;
}

inline int MQCShaderNode::GetMappingName(int index, char* buffer, int buffer_size)
{
	int length = 0;
	void* array[4];
	array[0] = &index;
	...
	array[2] = &buffer_size;
	array[3] = &length;
	MQShaderNode_GetValueArray(this, MQMAT_ID_SHADER_MAP_NAME, array);
	return length;
}

inline std::string MQCShaderNode::GetMappingName(int index)
{
	char buffer[64];
	GetMappingName(index, buffer, sizeof(buffer));
	return std::string(buffer);
}

inline int MQCShaderNode::GetMappingFilename(int index, char* buffer, int buffer_size)
{
	int length = 0;
	void* array[5];
	array[0] = &index;
	...
	array[3] = &buffer_size;
	array[4] = &length;
	MQShaderNode_GetValueArray(this, MQMAT_ID_SHADER_MAP_FILENAME, array);
	return length;
}

inline int MQCShaderNode::GetMappingFilename(const char* name, char* buffer, int buffer_size)
{
	int length = 0;
	void* array[5];
	array[0] = nullptr;
...
inline int MQCShaderNode::GetMappingFilename(int index, wchar_t* buffer, int buffer_size)
{
	int length = 0;
	void* array[5];
	array[0] = &index;
	...
	array[3] = &buffer_size;
	array[4] = &length;
	MQShaderNode_GetValueArray(this, MQMAT_ID_SHADER_MAP_FILENAME_W, array);
	return length;
}

inline int MQCShaderNode::GetMappingFilename(const char* name, wchar_t* buffer, int buffer_size)
{
	int length = 0;
	void* array[5];
	array[0] = nullptr;
...
inline std::string MQCShaderNode::GetMappingFilename(int index)
{
	int len = GetMappingFilename(index, (char*)nullptr, 0);
	if (len == 0) return std::string();
	char* buffer = new char[len + 1];
	GetMappingFilename(index, buffer, len + 1);
	std::string str(buffer);
	delete[] buffer;
	return str;
}

inline std::string MQCShaderNode::GetMappingFilename(const char* name)
{
	int len = GetMappingFilename(name, (wchar_t*)nullptr, 0);
	if (len == 0) return std::string();
	char* buffer = new char[len + 1];
	GetMappingFilename(name, buffer, len + 1);
	std::string str(buffer);
	delete[] buffer;
	return str;
}

inline std::wstring MQCShaderNode::GetMappingFilenameW(int index)
{
	int len = GetMappingFilename(index, (wchar_t*)nullptr, 0);
	if (len == 0) return std::wstring();
	wchar_t* buffer = new wchar_t[len + 1];
	GetMappingFilename(index, buffer, len + 1);
	std::wstring str(buffer);
...
inline std::wstring MQCShaderNode::GetMappingFilenameW(const char* name)
{
	int len = GetMappingFilename(name, (wchar_t*)nullptr, 0);
	if (len == 0) return std::wstring();
	wchar_t* buffer = new wchar_t[len + 1];
...
inline void MQCShaderNode::SetMappingFilename(int index, const char* buffer)
{
	void* array[3];
	array[0] = &index;
	array[1] = nullptr;
	array[2] = (void*)buffer;
	MQShaderNode_SetValueArray(this, MQMAT_ID_SHADER_MAP_FILENAME, array);
}

inline void MQCShaderNode::SetMappingFilename(const char* name, const char* buffer)
{
	void* array[3];
	array[0] = nullptr;
	array[1] = (void*)name;
...
inline void MQCShaderNode::SetMappingFilename(int index, const wchar_t* buffer)
{
	void* array[3];
	array[0] = &index;
	array[1] = nullptr;
	array[2] = (void*)buffer;
	MQShaderNode_SetValueArray(this, MQMAT_ID_SHADER_MAP_FILENAME_W, array);
}

inline void MQCShaderNode::SetMappingFilename(const char* name, const wchar_t* buffer)
{
	void* array[3];
	array[0] = nullptr;
	array[1] = (void*)name;
...
{
	int length = GetMappingOptionValue(index, option_name, nullptr, 0);
	if (length == 0) return std::string();
	char* buffer = (char*)malloc(length + 1);
...
{
	int length = GetMappingOptionValue(name, option_name, nullptr, 0);
	if (length == 0) return std::string();
	char* buffer = (char*)malloc(length + 1);
...
inline bool MQCShaderNode::GetMappingConnectedNodeID(int index, std::string& node_id, std::string& output)
{
	...
	void* array[8] = {&index, nullptr, nullptr, nullptr, &name_len, nullptr, nullptr, &output_len};
	MQShaderNode_GetValueArray(this, MQMAT_ID_SHADER_MAP_CONNECT_NODE_ID, array);
	if (name_len == 0 && output_len)
	{
		node_id.clear();
		output.clear();
		return false;
	...
	array[2] = name_buf;
	array[3] = &name_bufsize;
	array[5] = output_buf;
	array[6] = &output_bufsize;
	MQShaderNode_GetValueArray(this, MQMAT_ID_SHADER_MAP_CONNECT_NODE_ID, array);
	node_id = std::string(name_buf);
	output = std::string(output_buf);
	delete[] name_buf;
	delete[] output_buf;
	return true;
}
...
{
	int name_len = 0, output_len = 0;
	void* array[8] = {nullptr, (void*)name, nullptr, nullptr, &name_len, nullptr, nullptr, &output_len};
	MQShaderNode_GetValueArray(this, MQMAT_ID_SHADER_MAP_CONNECT_NODE_ID, array);
	if (name_len == 0 && output_len)
	{
		node_id.clear();
...
inline void MQCShaderNode::SetMappingConnectedNodeID(int index, const char* node_id, const char* output)
{
	void* array[4] = {&index, nullptr, (void*)node_id, (void*)output};
	MQShaderNode_SetValueArray(this, MQMAT_ID_SHADER_MAP_CONNECT_NODE_ID, array);
}

inline void MQCShaderNode::SetMappingConnectedNodeID(const char* name, const char* node_id, const char* output)
{
	void* array[4] = {nullptr, (void*)name, (void*)node_id, (void*)output};
	MQShaderNode_SetValueArray(this, MQMAT_ID_SHADER_MAP_CONNECT_NODE_ID, array);
}

inline MQShaderNode MQCShaderNode::GetMappingConnectedNode(int index)
{
	MQShaderNode result = nullptr;
	void* array[3] = {&index, nullptr, &result};
	MQShaderNode_GetValueArray(this, MQMAT_ID_SHADER_MAP_CONNECT_NODE, array);
	return result;
}

inline MQShaderNode MQCShaderNode::GetMappingConnectedNode(const char* name)
{
	MQShaderNode result = nullptr;
	void* array[3] = {nullptr, (void*)name, &result};
	MQShaderNode_GetValueArray(this, MQMAT_ID_SHADER_MAP_CONNECT_NODE, array);
	return result;
}

inline int MQCShaderNode::GetMappingParameterNum(int map_index)
{
	int num = 0;
	void* array[3];
	array[0] = &map_index;
	array[1] = nullptr;
	array[2] = &num;
	MQShaderNode_GetValueArray(this, MQMAT_ID_SHADER_MAP_PARAM_NUM, array);
	return num;
}

inline int MQCShaderNode::GetMappingParameterNum(const char* map_name)
{
	int num = 0;
	void* array[3];
	array[0] = nullptr;
...
inline int MQCShaderNode::GetMappingParameterName(int map_index, int param_index, char* buffer, int buffer_size)
{
	int length = 0;
	void* array[6];
	array[0] = &map_index;
	...
	array[4] = &buffer_size;
	array[5] = &length;
	MQShaderNode_GetValueArray(this, MQMAT_ID_SHADER_MAP_PARAM_NAME, array);
	return length;
}

inline std::string MQCShaderNode::GetMappingParameterName(int map_index, int param_index)
{
	char buffer[64];
	GetMappingParameterName(map_index, param_index, buffer, sizeof(buffer));
	return std::string(buffer);
}

inline int MQCShaderNode::GetMappingParameterName(const char* map_name, int param_index, char* buffer, int buffer_size)
{
	int length = 0;
	void* array[6];
	array[0] = nullptr;
...
inline std::string MQCShaderNode::GetMappingParameterName(const char* map_name, int param_index)
{
	char buffer[64];
	GetMappingParameterName(map_name, param_index, buffer, sizeof(buffer));
	return std::string(buffer);
}
...
{
	int length = GetMappingParameterOptionValue(map_index, param_index, option_name, nullptr, 0);
	if (length == 0) return std::string();
	char* buffer = (char*)malloc(length + 1);
...
{
	int length = GetMappingParameterOptionValue(map_name, param_index, option_name, nullptr, 0);
	if (length == 0) return std::string();
	char* buffer = (char*)malloc(length + 1);
...
{
	int length = GetMappingParameterOptionValue(map_name, param_name, option_name, nullptr, 0);
	if (length == 0) return std::string();
	char* buffer = (char*)malloc(length + 1);
...
inline int MQCShaderNode::GetMappingParameterValueType(int map_index, int param_index)
{
	int type = 0;
	void* array[5];
	array[0] = &map_index;
	...
	array[3] = nullptr;
	array[4] = &type;
	MQShaderNode_GetValueArray(this, MQMAT_ID_SHADER_MAP_PARAM_VALUE_TYPE, array);
	return type;
}

inline int MQCShaderNode::GetMappingParameterValueType(const char* map_name, int param_index)
{
	int type = 0;
	void* array[5];
	array[0] = nullptr;
...
inline int MQCShaderNode::GetMappingParameterValueType(const char* map_name, const char* param_name)
{
	int type = 0;
	void* array[5];
	array[0] = nullptr;
...
inline int MQCShaderNode::GetMappingParameterArraySize(int map_index, int param_index)
{
	int num = 0;
	void* array[5];
	array[0] = &map_index;
	...
	array[3] = nullptr;
	array[4] = &num;
	MQShaderNode_GetValueArray(this, MQMAT_ID_SHADER_MAP_PARAM_ARRAY_SIZE, array);
	return num;
}

inline int MQCShaderNode::GetMappingParameterArraySize(const char* map_name, int param_index)
{
	int num = 0;
	void* array[5];
	array[0] = nullptr;
...
inline int MQCShaderNode::GetMappingParameterArraySize(const char* map_name, const char* param_name)
{
	int num = 0;
	void* array[5];
	array[0] = nullptr;
...
inline bool MQCShaderNode::GetMappingParameterBoolValue(int map_index, int param_index, int array_index)
{
	int value = 0;
	void* array[6];
	array[0] = &map_index;
	...
	array[4] = &array_index;
	array[5] = &value;
	MQShaderNode_GetValueArray(this, MQMAT_ID_SHADER_MAP_PARAM_INT_VALUE, array);
	return value != 0;
}

inline bool MQCShaderNode::GetMappingParameterBoolValue(const char* map_name, int param_index, int array_index)
{
	int value = 0;
	void* array[6];
	array[0] = nullptr;
...
inline bool MQCShaderNode::GetMappingParameterBoolValue(const char* map_name, const char* param_name, int array_index)
{
	int value = 0;
	void* array[6];
	array[0] = nullptr;
...
inline int MQCShaderNode::GetMappingParameterIntValue(int map_index, int param_index, int array_index)
{
	int value = 0;
	void* array[6];
	array[0] = &map_index;
...
inline int MQCShaderNode::GetMappingParameterIntValue(const char* map_name, int param_index, int array_index)
{
	int value = 0;
	void* array[6];
	array[0] = nullptr;
...
inline int MQCShaderNode::GetMappingParameterIntValue(const char* map_name, const char* param_name, int array_index)
{
	int value = 0;
	void* array[6];
	array[0] = nullptr;
...
inline float MQCShaderNode::GetMappingParameterFloatValue(int map_index, int param_index, int array_index)
{
	float value = 0;
	void* array[6];
	array[0] = &map_index;
	...
	array[4] = &array_index;
	array[5] = &value;
	MQShaderNode_GetValueArray(this, MQMAT_ID_SHADER_MAP_PARAM_FLOAT_VALUE, array);
	return value;
}

inline float MQCShaderNode::GetMappingParameterFloatValue(const char* map_name, int param_index, int array_index)
{
	float value = 0;
	void* array[6];
	array[0] = nullptr;
...
inline float MQCShaderNode::GetMappingParameterFloatValue(const char* map_name, const char* param_name, int array_index)
{
	float value = 0;
	void* array[6];
	array[0] = nullptr;
...
inline MQColorRGBA MQCShaderNode::GetMappingParameterColorValue(int map_index, int param_index, int array_index)
{
	MQColorRGBA value(0, 0, 0, 0);
	void* array[6];
	array[0] = &map_index;
	...
	array[4] = &array_index;
	array[5] = &value;
	MQShaderNode_GetValueArray(this, MQMAT_ID_SHADER_MAP_PARAM_COLOR_VALUE, array);
	return value;
}

inline MQColorRGBA MQCShaderNode::GetMappingParameterColorValue(const char* map_name, int param_index, int array_index)
{
	MQColorRGBA value(0, 0, 0, 0);
	void* array[6];
	array[0] = nullptr;
...
inline MQColorRGBA MQCShaderNode::GetMappingParameterColorValue(const char* map_name, const char* param_name, int array_index)
{
	MQColorRGBA value(0, 0, 0, 0);
	void* array[6];
	array[0] = nullptr;
...
inline std::string MQCShaderNode::GetMappingParameterStringValue(int map_index, int param_index, int array_index)
{
	const char* value = nullptr;
	void* array[6];
	array[0] = &map_index;
	...
	array[4] = &array_index;
	array[5] = &value;
	MQShaderNode_GetValueArray(this, MQMAT_ID_SHADER_MAP_PARAM_STRING_VALUE, array);
	if (value == nullptr) return std::string();
	return std::string(value);
}

inline std::string MQCShaderNode::GetMappingParameterStringValue(const char* map_name, int param_index, int array_index)
{
	const char* value = nullptr;
	void* array[6];
	array[0] = nullptr;
...
inline std::string MQCShaderNode::GetMappingParameterStringValue(const char* map_name, const char* param_name, int array_index)
{
	const char* value = nullptr;
	void* array[6];
	array[0] = nullptr;
...
inline void MQCShaderNode::SetMappingParameterBoolValue(int map_index, int param_index, int array_index, bool value)
{
	void* array[6];
	array[0] = &map_index;
	array[1] = nullptr;
	...
	array[4] = &array_index;
	array[5] = &value;
	MQShaderNode_SetValueArray(this, MQMAT_ID_SHADER_MAP_PARAM_INT_VALUE, array);
}

inline void MQCShaderNode::SetMappingParameterBoolValue(const char* map_name, int param_index, int array_index, bool value)
{
	void* array[6];
	array[0] = nullptr;
	array[1] = (void*)map_name;
...
inline void MQCShaderNode::SetMappingParameterBoolValue(const char* map_name, const char* param_name, int array_index, bool value)
{
	void* array[6];
	array[0] = nullptr;
	array[1] = (void*)map_name;
...
inline void MQCShaderNode::SetMappingParameterIntValue(int map_index, int param_index, int array_index, int value)
{
	void* array[6];
	array[0] = &map_index;
	array[1] = nullptr;
...
inline void MQCShaderNode::SetMappingParameterIntValue(const char* map_name, int param_index, int array_index, int value)
{
	void* array[6];
	array[0] = nullptr;
	array[1] = (void*)map_name;
...
inline void MQCShaderNode::SetMappingParameterIntValue(const char* map_name, const char* param_name, int array_index, int value)
{
	void* array[6];
	array[0] = nullptr;
	array[1] = (void*)map_name;
...
inline void MQCShaderNode::SetMappingParameterFloatValue(int map_index, int param_index, int array_index, float value)
{
	void* array[6];
	array[0] = &map_index;
	array[1] = nullptr;
	...
	array[4] = &array_index;
	array[5] = &value;
	MQShaderNode_SetValueArray(this, MQMAT_ID_SHADER_MAP_PARAM_FLOAT_VALUE, array);
}

inline void MQCShaderNode::SetMappingParameterFloatValue(const char* map_name, int param_index, int array_index, float value)
{
	void* array[6];
	array[0] = nullptr;
	array[1] = (void*)map_name;
...
inline void MQCShaderNode::SetMappingParameterFloatValue(const char* map_name, const char* param_name, int array_index, float value)
{
	void* array[6];
	array[0] = nullptr;
	array[1] = (void*)map_name;
...
inline void MQCShaderNode::SetMappingParameterColorValue(int map_index, int param_index, int array_index, MQColorRGBA color)
{
	void* array[6];
	array[0] = &map_index;
	array[1] = nullptr;
	...
	array[4] = &array_index;
	array[5] = &color;
	MQShaderNode_SetValueArray(this, MQMAT_ID_SHADER_MAP_PARAM_COLOR_VALUE, array);
}

inline void MQCShaderNode::SetMappingParameterColorValue(const char* map_name, int param_index, int array_index, MQColorRGBA color)
{
	void* array[6];
	array[0] = nullptr;
	array[1] = (void*)map_name;
...
inline void MQCShaderNode::SetMappingParameterColorValue(const char* map_name, const char* param_name, int array_index, MQColorRGBA color)
{
	void* array[6];
	array[0] = nullptr;
	array[1] = (void*)map_name;
...
inline void MQCShaderNode::SetMappingParameterStringValue(int map_index, int param_index, int array_index, const char* str)
{
	void* array[6];
	array[0] = &map_index;
	array[1] = nullptr;
	...
	array[4] = &array_index;
	array[5] = (void*)str;
	MQShaderNode_SetValueArray(this, MQMAT_ID_SHADER_MAP_PARAM_STRING_VALUE, array);
}

inline void MQCShaderNode::SetMappingParameterStringValue(const char* map_name, int param_index, int array_index, const char* str)
{
	void* array[6];
	array[0] = nullptr;
	array[1] = (void*)map_name;
...
inline void MQCShaderNode::SetMappingParameterStringValue(const char* map_name, const char* param_name, int array_index, const char* str)
{
	void* array[6];
	array[0] = nullptr;
	array[1] = (void*)map_name;
...
inline int MQCShaderNode::GetOutputParameterNum(void)
{
	int num = 0;
	void* array[1];
	array[0] = &num;
	MQShaderNode_GetValueArray(this, MQMAT_ID_SHADER_OUTPUT_NUM, array);
	return num;
}

inline int MQCShaderNode::GetOutputParameterName(int index, char* buffer, int buffer_size)
{
	int length = 0;
	void* array[4];
	array[0] = &index;
	...
	array[2] = &buffer_size;
	array[3] = &length;
	MQShaderNode_GetValueArray(this, MQMAT_ID_SHADER_OUTPUT_NAME, array);
	return length;
}

inline std::string MQCShaderNode::GetOutputParameterName(int index)
{
	char buffer[64];
	GetOutputParameterName(index, buffer, sizeof(buffer));
	return std::string(buffer);
}
...
{
	int length = GetOutputParameterOptionValue(index, option_name, nullptr, 0);
	if (length == 0) return std::string();
	char* buffer = (char*)malloc(length + 1);
...
{
	int length = GetOutputParameterOptionValue(name, option_name, nullptr, 0);
	if (length == 0) return std::string();
	char* buffer = (char*)malloc(length + 1);
...
inline int MQCShaderNode::GetOutputParameterValueType(int index)
{
	int type = 0;
	void* array[3];
	array[0] = &index;
	array[1] = nullptr;
	array[2] = &type;
	MQShaderNode_GetValueArray(this, MQMAT_ID_SHADER_OUTPUT_VALUE_TYPE, array);
	return type;
}

inline int MQCShaderNode::GetOutputParameterValueType(const char* name)
{
	int type = 0;
	void* array[3];
	array[0] = nullptr;
...
// class MQMatrix
inline MQPoint MQMatrix::GetScaling() const
{
	float val[3];
	MQMatrix_FloatValue((float*)this->t, MQMATRIX_GET_SCALING, val);
	return MQPoint(val[0], val[1], val[2]);
}

inline MQAngle MQMatrix::GetRotation() const
{
	float val[3];
	MQMatrix_FloatValue((float*)this->t, MQMATRIX_GET_ROTATION, val);
	return MQAngle(val[0], val[1], val[2]);
}

inline MQPoint MQMatrix::GetTranslation() const
{
	float val[3];
	MQMatrix_FloatValue((float*)this->t, MQMATRIX_GET_TRANSLATION, val);
	return MQPoint(val[0], val[1], val[2]);
}
